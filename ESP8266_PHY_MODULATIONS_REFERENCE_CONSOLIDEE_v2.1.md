...
## Référence consolidée du projet de reverse-engineering — v2.1

**Date de consolidation initiale : 2026-09-13 — révision v2.1 : 2026-09-18**  
...
|---|---:|---:|---|
| OOK | **100 %** | **100 % logiciel pour le chemin canonique à gain fixe** | génération + IQ_EST + gain/PBUS/noise-floor fermés ; mesures RF ouvertes |
...
Le chemin logiciel canonique est désormais fermé à **100 % dans le corpus analysé**. Les questions restantes sont physiques/statistiques :

```text
digital_scale→amplitude RF / dBm
PWDET/SAR→dBm absolu et dérive
E4/Corr²/DC²→niveau RF
N→temps matériel exact
...
5. calculer `Dmin` et BER pour décider objectivement entre OOK, 2-ASK, 4-ASK et éventuellement 8-ASK.
...
```text
OOK/ASK/M-ASK : chemin logiciel fonctionnel canonique fermé à 100 %
