...
## Consolidated Reverse-Engineering Project Reference — v2.1

**Initial consolidation date: 2026-09-13 — v2.1 revision: 2026-09-18**  
...
> **Normative rule.** Parts I through XII of this document form the normative v2.1 synthesis. The appendices preserve the four complete v1.0 references and the QAM v0.60→v0.83 history so that no source information is lost. Where historical wording differs from the v2.0 synthesis, the v2.0 synthesis takes precedence.
...
|---|---:|---:|---|
| OOK | **100%** | **100% software for the canonical fixed-gain path** | generation + IQ_EST + gain/PBUS/noise-floor closed; RF measurements remain open |
...
The canonical software path is now closed at **100% within the analyzed corpus**. Remaining questions are physical/statistical:

```text
digital_scale→RF amplitude / dBm
PWDET/SAR→absolute dBm and drift
E4/Corr²/DC²→RF level
N→exact hardware time
...
5. compute `Dmin` and BER to objectively choose among OOK, 2-ASK, 4-ASK and possibly 8-ASK.
